...
exports.newValidation = function(swNames, req) {
  ...
  // get the current sw names list
    //console.log("validation swNames array: "+JSON.stringify(swNames, null, 2));
    //console.log("validation req.swName: "+JSON.stringify(req.body.swName));
  req.checkBody("swName","Software Name must be in the sw name list")
    .isIn(swNames);
    //console.log("validation req errors: "+JSON.stringify(req._validationErrors, null, 2));
