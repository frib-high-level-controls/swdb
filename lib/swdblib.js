...
exports.newValidation = function(swNames, req) {
  ...
  req.checkBody("desc","Description must be a string")
    .optional().isAscii().isLength({min:1, max:2048});
  ...
  req.checkBody("previous","Previous version reference must be 1-30 characters")
    .optional().isAscii().isLength({min:1,max:30});
  req.checkBody("comment","Comment must be a string").optional().isAscii().isLength({min:1, max:2048});
...
exports.updateValidation = function(swNames, req) {
  ...
  req.checkBody("previous","Previous version reference must be 1-30 characters")
    .optional().isAscii().isLength({min:1,max:30});
  req.checkBody("comment","Comment must be a string")
    .optional().isAscii().isLength({min:1, max:2048});
