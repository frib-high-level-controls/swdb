...
var InstLib = /** @class */ (function () {
    function InstLib() {
    }
    InstLib.getReqId = function (req) {
        var id = null;
    ...
    InstLib.getSlot = function (req, res, next) {
    ...
    InstLib.newValidation = function (req) {
        req.checkBody({
            host: {
                notEmpty: {
    ...
    InstLib.updateValidation = function (req) {
        req.checkBody({
            host: {
                optional: true,
                isString: {
    ...
    InstLib.updateSanitization = function (req) {
    };
    return InstLib;
}());
exports.InstLib = InstLib;
