...
test.describe('Installations record tests', () => {
  ...
  test.it('should show SW name columns names in proper order', () => {
  ...
  test.it('should show Version column names in proper order', () => {
  ...
  test.it('should show Owner column names in proper order', () => {
  ...
  test.it('should show Engineer column names in proper order', () => {
  ...
  test.it('should find a sw record', function(this: any) {
    ...
    chromeDriver.wait(until.elementLocated(By.linkText('BEAST')),
      8000);
    const link = chromeDriver.findElement(By.linkText('BEAST'));
